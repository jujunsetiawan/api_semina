...
const updateEvents = async (req) => {
  ...
  const result = await Events.findOneAndUpdate(
    { _id: id },
    { title, date, about, tagline, venueName, keyPoint, statusEvent, tickets, image, category, talent },
...
module.exports = { getAllEvents, createEvents, getOneEvents, updateEvents, deleteEvents }